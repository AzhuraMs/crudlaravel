    ...
    <form action="{{ route('produtos.update', $produto->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Custo:</strong>
                    <input type="number" step="0.01" name="precoUnitario" value="{{ $produto->precoUnitario }}" class="form-control" placeholder="Custo">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Venda:</strong>
                    <input type="number" step="0.01" name="precoVenda" value="{{ $produto->precoVenda }}" class="form-control" placeholder="Venda">
                </div>
            </div>
